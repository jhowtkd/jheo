...
export function buildExecutiveReportPrompt(
  ...
  const system = locale === 'pt-BR'
    ? [
        ...
        '- topIssues: array (1–15) de { rule, title, businessImpact, impactLevel ("high"|"medium"|"low"), affectedPages }',
    ...
    : [
        ...
        '- topIssues: array (1–15) of { rule, title, businessImpact, impactLevel ("high"|"medium"|"low"), affectedPages }',
