      ...
      <div className="page__header">
        <div>
          <div className="row" style={{ marginBottom: 'var(--space-2)', gap: 'var(--space-2)' }}>
            <Link to={localePath('templates')} className="muted tiny">
          ...
          <h1 className="page__title">
            {tpl.name}{' '}
            <span className="muted tabular" style={{ fontWeight: 400, fontSize: 'var(--fs-lg)' }}>
              v{tpl.version}
            </span>
          </h1>
        </div>
      ...
      <div className="col" style={{ gap: 'var(--space-4)' }}>
        ...
        <div className="card">
          ...
          <dl className="fm-table">
            ...
            <dd>{tpl.id}</dd>
            <dt>{t('templates.editor.createdLabel')}</dt>
            <dd>{new Date(tpl.createdAt).toLocaleString()}</dd>
          </dl>
        </div>
      </div>
    </div>
