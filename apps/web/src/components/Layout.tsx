  ...
  return (
    <div className="topbar__health" title={down ? 'Backend unreachable' : 'Backend healthy'}>
      <span
        ...
        style={
          down
            ? { background: 'var(--danger)', boxShadow: '0 0 8px rgba(239,68,68,0.4)' }
            : undefined
        }
      />
      <span>
        ...
        {down
          ? t('topbar.down')
          : status === 'reachable' && latencyMs !== null
            ? `${latencyMs}ms`
            : '…'}
      </span>
    </div>
      ...
      <aside className="sidebar">
        <div className="sidebar__brand">
          ...
          <div className="sidebar__wordmark">
            ...
            <div className="sidebar__wordmark-tag" title={t('app.taglineHint')}>
              {t('app.tagline')}
            </div>
          </div>
        </div>
